# This file was originally auto-generated by O2 with contents hashing to 5228b8c57b9bfc5126d92d7148e50196
use strict;
...
my $mgr = $context->getSingleton('O2Plugin::Shop::Mgr::ProductManager');

my $newObj = $mgr->newObject();
$newObj->setMetaName('Test-script for O2Plugin::Shop::Obj::Product/O2Plugin::Shop::Mgr::ProductManager');
...
$newObj->setVariantOptionIds( $newObj->getManager()->getTestVariantOptionIds() );
