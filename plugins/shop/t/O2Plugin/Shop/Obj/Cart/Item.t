# This file was originally auto-generated by O2 with contents hashing to 64871afbcbdf817444471a703ec0c2ff
use strict;
...
my $mgr = $context->getSingleton('O2Plugin::Shop::Mgr::Cart::ItemManager');

my $newObj = $mgr->newObject();
$newObj->setMetaName('Test-script for O2Plugin::Shop::Obj::Cart::Item/O2Plugin::Shop::Mgr::Cart::ItemManager');
...
$newObj->setVariantOptionIds('a' => '1', 'b' => '2', );
...
is_deeply( { $dbObj->getVariantOptionIds() }, { $newObj->getVariantOptionIds() }, 'variantOptionIds retrieved ok.' );
...
is( $dbObj->getAmount(), $newObj->getAmount(), 'amount retrieved ok.' );
