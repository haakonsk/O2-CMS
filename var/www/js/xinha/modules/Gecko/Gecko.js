  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --   that way.
    --
    --  $HeadURL: http://svn.xinha.org/tags/0.96.1/modules/Gecko/Gecko.js $
...
Gecko._pluginInfo = {
  ...
  developer_url : "$HeadURL: http://svn.xinha.org/tags/0.96.1/modules/Gecko/Gecko.js $".replace(/^[^:]*:\s*(.*)\s*\$$/, '$1'),
  sponsor       : "",
  sponsor_url   : "",
  license       : "htmlArea"
};
