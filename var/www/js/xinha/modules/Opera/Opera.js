  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --   that way.
    --
    --  $HeadURL: http://svn.xinha.org/tags/0.96.1/modules/Opera/Opera.js $
...
Opera._pluginInfo = {
  ...
  developer_url : "$HeadURL: http://svn.xinha.org/tags/0.96.1/modules/Opera/Opera.js $".replace(/^[^:]*:\s*(.*)\s*\$$/, '$1'),
