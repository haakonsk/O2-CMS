  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --
    --
    --  $HeadURL: http://svn.xinha.org/tags/0.96.1/modules/InsertTable/insert_table.js $
    --  $LastChangedDate: 2008-10-12 19:52:26 +0200 (sø., 12 okt. 2008) $
...
InsertTable._pluginInfo = {
  ...
  developer_url : "$HeadURL: http://svn.xinha.org/tags/0.96.1/modules/InsertTable/insert_table.js $".replace(/^[^:]*:\s*(.*)\s*\$$/, '$1'),
  sponsor       : "",
  sponsor_url   : "",
  license       : "htmlArea"
};
