  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --   that way.
    --
    --  $HeadURL: http://svn.xinha.org/tags/0.96.1/modules/WebKit/WebKit.js $
    --  $LastChangedDate: 2008-12-30 20:18:54 +0100 (ti., 30 des. 2008) $
...
WebKit._pluginInfo = {
  ...
  developer_url : "$HeadURL: http://svn.xinha.org/tags/0.96.1/modules/WebKit/WebKit.js $".replace(/^[^:]*:\s*(.*)\s*\$$/, '$1'),
  sponsor       : "",
  sponsor_url   : "",
  license       : "htmlArea"
};
