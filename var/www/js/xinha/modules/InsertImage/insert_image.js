  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --
    --
    --  $HeadURL: http://svn.xinha.org/tags/0.96.1/modules/InsertImage/insert_image.js $
    --  $LastChangedDate: 2010-02-18 03:14:45 +0100 (to., 18 feb. 2010) $
...
InsertImage._pluginInfo = {
  ...
  developer_url : "$HeadURL: http://svn.xinha.org/tags/0.96.1/modules/InsertImage/insert_image.js $".replace(/^[^:]*:\s*(.*)\s*\$$/, '$1'),
  sponsor       : "",
  sponsor_url   : "",
  license       : "htmlArea"
};
