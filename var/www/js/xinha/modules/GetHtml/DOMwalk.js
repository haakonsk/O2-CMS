  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --
    --
    --  $HeadURL: http://svn.xinha.org/tags/0.96.1/modules/GetHtml/DOMwalk.js $
    --  $LastChangedDate: 2009-04-14 11:07:43 +0200 (ti., 14 april 2009) $
...
GetHtmlImplementation._pluginInfo = {
  ...
  developer_url : "$HeadURL: http://svn.xinha.org/tags/0.96.1/modules/GetHtml/DOMwalk.js $".replace(/^[^:]*:\s*(.*)\s*\$$/, '$1'),
  sponsor       : "",
  sponsor_url   : "",
  license       : "htmlArea"
};
